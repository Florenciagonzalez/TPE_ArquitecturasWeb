package com.tpe.apigateway.security;

import com.tpe.apigateway.dto.ValidateTokenDTO;
...
public class AuthenticationFilter extends AbstractGatewayFilterFactory<AuthenticationFilter.Config> {
    ...
    List<String> excludedUrls = List.of( "usuarios/autenticar" , "usuarios/registrarse");
        ...
        return (exchange, chain) -> {
            ...
            if(this.isSecured.test(request)){
                return webClientBuilder.build().get()
                        .uri("http://localhost:8001/usuarios/validate")
